...
class MarketplaceEntryPageAddTests(TestCase):
    ...
    def setUp(self):
        ...
        self.marketplace_submission_slug = '/%s/submit-marketplace-entry/' % self.marketplace_index_page.slug
        ...
        self.case_study_submission_slug = '/%s/submit-case-study/' % self.case_study_index_page.slug
        ...
        self.blog_submission_slug = '/%s/submit-blog/' % self.blog_index_page.slug
    ...
    def test_marketplace_entry_form_valid(self):
        ...
        resp = self.client.post(self.marketplace_submission_slug, self.marketplace_entry_form_data)
    ...
    def test_case_study_form_valid(self):
        ...
        resp = self.client.post(self.case_study_submission_slug, self.case_study_form_data)
        self.assertEqual(resp.status_code, 302)
    ...
    def test_blog_form_valid(self):
        ...
        resp = self.client.post(self.blog_submission_slug, self.blog_form_data)
        self.assertEqual(resp.status_code, 302)
