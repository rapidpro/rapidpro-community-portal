...
You can use the below OpenSSL commands to generate the key and signing request::
  ...
  openssl genrsa -out rapidpro_community_portal.key 2048
  # Make copy of the key with the passphrase
  cp rapidpro_community_portal.key rapidpro_community_portal.key.secure
  # Remove any passphrase
  openssl rsa -in rapidpro_community_portal.secure -out rapidpro_community_portal.key
  # Generate signing request
  openssl req -new -key rapidpro_community_portal.key -out rapidpro_community_portal.csr
