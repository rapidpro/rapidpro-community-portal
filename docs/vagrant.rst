...
staging instead of dev::
    ...
    # Example local.py
    from rapidpro_community_portal.settings.staging import *

    # Override settings here
    DATABASES['default']['NAME'] = 'rapidpro_community_portal_local'
    DATABASES['default']['USER'] = 'rapidpro_community_portal_local'
